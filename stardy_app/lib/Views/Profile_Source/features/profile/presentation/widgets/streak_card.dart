...
class StreakCard extends StatelessWidget {
  ...
  Widget _mainCard(BuildContext context) {
    final displayName = username.replaceAll('@', '').split('_').first;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 4),
          Text(
            "You're doing really great $greetingName",
          ...
          Container(
            ...
            child: Image.asset('assets/images/flame.png', fit: BoxFit.contain),
          ),
          const SizedBox(height: 18),
          Row(
