          ...
          child: _currentPage == 4
              ...
              : Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color:
                        _currentPage == 0 ? AppColors.white : AppColors.black,
                  ),
                  child: Icon(
                    Icons.arrow_forward,
                    color:
          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _usedBefore ? AppColors.primary : AppColors.white,
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color:
                        _usedBefore ? AppColors.primary : Colors.grey.shade300,
                  ),
                ),
                child: Text(
                  'Yes',
                  style: GoogleFonts.mukta(
                    fontSize: 15,
                    fontWeight: FontWeight.w500,
                    color: _usedBefore ? AppColors.white : AppColors.black,
                    letterSpacing: -0.8,
                  ),
                ),
              ),
